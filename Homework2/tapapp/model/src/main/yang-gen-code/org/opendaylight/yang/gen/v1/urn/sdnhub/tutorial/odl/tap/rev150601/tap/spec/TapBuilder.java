...
public class TapBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.sdnhub.tutorial.odl.tap.rev150601.tap.spec.Tap> {
    ...
    */
    ...
    public TapBuilder setId(java.lang.String value) {
        this._id = value;
        return this;
    }
    
    public TapBuilder setIpAddressMatch(IpAddressMatch value) {
        this._ipAddressMatch = value;
        return this;
    }
    
    public TapBuilder setKey(TapKey value) {
        this._key = value;
        return this;
    }
    
    public TapBuilder setMacAddressMatch(MacAddressMatch value) {
        this._macAddressMatch = value;
        return this;
    }
    
    public TapBuilder setNode(NodeId value) {
        if (value != null) {
        }
        this._node = value;
        return this;
    ...
    public TapBuilder setSinkNodeConnector(List<NodeConnectorId> value) {
        this._sinkNodeConnector = value;
        return this;
    }
    
    public TapBuilder setSrcNodeConnector(List<NodeConnectorId> value) {
        this._srcNodeConnector = value;
        return this;
    }
    
    public TapBuilder setTrafficMatch(TrafficType value) {
    ...
    private static final class TapImpl implements Tap {
        ...
        public int hashCode() {
            ...
            result = prime * result + ((_macAddressMatch == null) ? 0 : _macAddressMatch.hashCode());
            result = prime * result + ((_node == null) ? 0 : _node.hashCode());
            result = prime * result + ((_sinkNodeConnector == null) ? 0 : _sinkNodeConnector.hashCode());
            result = prime * result + ((_srcNodeConnector == null) ? 0 : _srcNodeConnector.hashCode());
            result = prime * result + ((_trafficMatch == null) ? 0 : _trafficMatch.hashCode());
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (_macAddressMatch == null) {
                if (other.getMacAddressMatch() != null) {
                    return false;
                }
            } else if(!_macAddressMatch.equals(other.getMacAddressMatch())) {
                return false;
            }
            if (_node == null) {
            ...
            if (_sinkNodeConnector == null) {
                if (other.getSinkNodeConnector() != null) {
                    return false;
                }
            } else if(!_sinkNodeConnector.equals(other.getSinkNodeConnector())) {
                return false;
            }
            if (_srcNodeConnector == null) {
                if (other.getSrcNodeConnector() != null) {
                    return false;
                }
            } else if(!_srcNodeConnector.equals(other.getSrcNodeConnector())) {
                return false;
            }
            if (_trafficMatch == null) {
                if (other.getTrafficMatch() != null) {
                    return false;
                }
            } else if(!_trafficMatch.equals(other.getTrafficMatch())) {
                return false;
            }
