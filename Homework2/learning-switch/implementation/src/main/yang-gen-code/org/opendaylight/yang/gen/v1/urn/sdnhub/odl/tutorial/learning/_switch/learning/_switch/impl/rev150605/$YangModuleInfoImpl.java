...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "learning-switch-impl";
    private final String namespace = "urn:sdnhub:odl:tutorial:learning-switch:learning-switch-impl";
    private final String revision = "2015-06-05";
    private final String resourcePath = "/META-INF/yang/learning-switch-impl.yang";
